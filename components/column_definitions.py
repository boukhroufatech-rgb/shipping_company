...
AGENTS_MARITIMES_COLUMNS = [
    ...
    {"name": "chiffre_affaire",    "label": "Chiffre d'affaires (DA)","type": "amount",    "width": 150, "sum": True},
    ...
    {"name": "payments_received",  "label": "Paiements (DA)",        "type": "amount",     "width": 150, "sum": True},
    {"name": "amount_due",         "label": "Dû (DA)",               "type": "amount",     "width": 150, "sum": True},
    {"name": "pending_payments",   "label": "En attente (DA)",       "type": "amount",     "width": 150, "sum": True},
    {"name": "balance",            "label": "Solde (DA)",            "type": "amount",     "width": 150, "sum": True},
...
AGENT_PAYMENTS_COLUMNS = [
    ...
    {"name": "amount",    "label": "Montant",   "type": "amount", "width": 130, "sum": True},
...
CONTAINERS_COLUMNS = [
    ...
    {"name": "amount_usd",           "label": "Montant ($)",      "type": "amount",     "width": 120, "sum": True},
    {"name": "taux",                 "label": "Taux",             "type": "amount",     "width": 100, "align": "right"},
    {"name": "equivalent_dzd",       "label": "Équivalent (DA)",  "type": "amount",     "width": 130, "sum": True},
    {"name": "taux_expedition",      "label": "Taux Expédition",  "type": "amount",     "width": 120, "align": "right"},
    {"name": "equivalent_expedition","label": "Revenus (DA)",     "type": "amount",     "width": 130, "sum": True},
    {"name": "port",                 "label": "Port",             "type": "text",       "width": 100},
    {"name": "transitaire",          "label": "Transitaire",      "type": "text",       "width": 100},
    {"name": "shipping",             "label": "Expédition (DA)",  "type": "amount",     "width": 130, "sum": True},
    {"name": "tax",                  "label": "Taxe (DA)",        "type": "amount",     "width": 130, "sum": True},
    {"name": "commission",           "label": "Commission (%)",   "type": "percentage", "width": 110, "align": "center"},
    {"name": "charge_da",            "label": "Frais (DA)",       "type": "amount",     "width": 130, "sum": True},
    {"name": "charge_port",          "label": "Frais Port",       "type": "amount",     "width": 130, "sum": True},
    {"name": "surestarie",           "label": "Surestarie",       "type": "amount",     "width": 130, "sum": True},
    {"name": "total_costs",          "label": "Coûts Total",      "type": "amount",     "width": 150, "sum": True},
    {"name": "revenue",              "label": "Revenus (DA)",     "type": "amount",     "width": 150, "sum": True},
    {"name": "profit",               "label": "Bénéfice (DA)",    "type": "amount",     "width": 150, "sum": True},
]
...
LOGISTICS_EXPENSES_COLUMNS = [
    ...
    {"name": "amount",     "label": "Montant (DA)","type": "amount", "width": 130, "sum": True},
    {"name": "reference",  "label": "Référence",   "type": "text",   "width": 120},
...
WIZARD_GOODS_COLUMNS = [
    ...
    {"name": "total",      "label": "Total (DA)",        "type": "amount", "width": 130, "sum": True},
    {"name": "action",     "label": "",                  "type": "text",   "width": 80},
]
...
CURRENCY_SUMMARY_COLUMNS = [
    ...
    {"name": "total_purchased", "label": "Total Acheté (+)",    "type": "amount", "width": 130, "sum": True},
    {"name": "total_consumed",  "label": "Total Consommé (-)",  "type": "amount", "width": 130, "sum": True},
    {"name": "balance",         "label": "Solde Actuel",        "type": "amount", "width": 130, "sum": True},
    {"name": "total_value_dzd", "label": "Valeur Totale (DA)",  "type": "amount", "width": 150, "sum": True},
    {"name": "balance_dzd",     "label": "Solde en DA",         "type": "amount", "width": 130, "sum": True},
]
...
SUPPLIER_PAYMENTS_COLUMNS = [
    ...
    {"name": "amount",      "label": "Montant Payé",  "type": "amount", "width": 130, "sum": True},
...
CURRENCY_PURCHASES_COLUMNS = [
    ...
    {"name": "supplier",     "label": "Fournisseur",    "type": "text",   "width": 150},
    {"name": "amount",       "label": "Montant Devise", "type": "amount", "width": 130, "sum": True},
    {"name": "rate",         "label": "Taux Change",    "type": "amount", "width": 120, "align": "right"},
    {"name": "total_da",     "label": "Total DA",       "type": "amount", "width": 130, "sum": True},
    {"name": "consumed",     "label": "Consommée",      "type": "amount", "width": 120, "align": "right"},
    {"name": "balance",      "label": "Solde",          "type": "amount", "width": 120, "sum": True},
...
SUPPLIERS_COLUMNS = [
    ...
    {"name": "balance", "label": "Solde (DA)",   "type": "amount", "width": 130, "sum": True},
]
...
CUSTOMER_LIST_COLUMNS = [
    ...
    {"name": "phone",           "label": "Téléphone",       "type": "text",   "width": 130, "align": "center"},
    {"name": "address",         "label": "Adresse",         "type": "text",   "width": 200},
    {"name": "initial_balance", "label": "Solde Initial",   "type": "amount", "width": 130, "sum": True},
    {"name": "business_number", "label": "N° Affaires",     "type": "number", "width": 100, "align": "center"},
    {"name": "fees",            "label": "Frais (DA)",      "type": "amount", "width": 130, "sum": True},
    {"name": "discounts",       "label": "Réductions (DA)", "type": "amount", "width": 130, "sum": True},
    {"name": "payments",        "label": "Paiements (DA)",  "type": "amount", "width": 130, "sum": True},
    {"name": "external_debt",   "label": "Dette Externe",   "type": "amount", "width": 130, "sum": True},
    {"name": "current_balance", "label": "Solde Actuel (DA)","type": "amount","width": 130, "sum": True},
    {"name": "notes",           "label": "Notes",           "type": "text",   "width": 200},
]
...
CUSTOMER_GOODS_COLUMNS = [
    ...
    {"name": "total_price", "label": "Total (DA)",  "type": "amount", "width": 130, "sum": True},
]
...
CUSTOMER_LEDGER_COLUMNS = [
    ...
    {"name": "debit",       "label": "Débit (DA)",   "type": "amount", "width": 130, "sum": True},
    {"name": "credit",      "label": "Crédit (DA)",  "type": "amount", "width": 130, "sum": True},
    {"name": "balance",     "label": "Solde (DA)",   "type": "amount", "width": 130},
]
...
EXPENSES_MAIN_COLUMNS = [
    ...
    {"name": "currency",        "label": "Devise",               "type": "text",   "width": 80,  "align": "center"},
    {"name": "amount",          "label": "Montant",              "type": "amount", "width": 130, "sum": True},
    {"name": "total_dzd",       "label": "Total (DA)",           "type": "amount", "width": 130, "sum": True},
...
EXTERNAL_CONTACTS_COLUMNS = [
    ...
    {"name": "name",          "label": "Nom",                   "type": "text",   "width": 200},
    {"name": "phone",         "label": "Téléphone",             "type": "text",   "width": 130, "align": "center"},
    {"name": "total_prete",   "label": "Total Prêté",           "type": "amount", "width": 140, "sum": True},
    {"name": "total_recu",    "label": "Total Reçu",            "type": "amount", "width": 140, "sum": True},
    {"name": "total_emprunt", "label": "Total Emprunté",        "type": "amount", "width": 140, "sum": True},
    {"name": "total_rembours","label": "Total Remboursé",       "type": "amount", "width": 140, "sum": True},
    {"name": "solde_net",     "label": "Solde Net",             "type": "amount", "width": 140, "sum": True},
]
...
EXTERNAL_JOURNAL_COLUMNS = [
    ...
    {"name": "contact",    "label": "Contact",      "type": "text",   "width": 150},
    {"name": "type",       "label": "Type",         "type": "text",   "width": 120, "align": "center"},
    {"name": "amount",     "label": "Montant",      "type": "amount", "width": 120, "sum": True},
    {"name": "currency",   "label": "Devise",       "type": "text",   "width": 80,  "align": "center"},
    {"name": "rate",       "label": "Taux",         "type": "amount", "width": 100, "align": "right"},
    {"name": "amount_da",  "label": "Montant (DA)", "type": "amount", "width": 130, "sum": True},
    {"name": "account",    "label": "Compte",       "type": "text",   "width": 120},
    {"name": "notes",      "label": "Notes",        "type": "text",   "width": 150},
]
...
TREASURY_ACCOUNTS_COLUMNS = [
    ...
    {"name": "currency",        "label": "Devise",       "type": "text",   "width": 100, "align": "center"},
    {"name": "initial_balance", "label": "Solde Initial","type": "amount", "width": 130, "sum": True},
    {"name": "balance",         "label": "Solde",        "type": "amount", "width": 130, "sum": True},
...
PARTNERS_COLUMNS = [
    ...
    {"name": "contributions",     "label": "M. Contributions","type": "amount",     "width": 130, "sum": True},
    {"name": "contribution_pct",  "label": "% Contrib.",      "type": "percentage", "width": 100, "align": "center"},
    {"name": "profit",            "label": "M. Profit",       "type": "amount",     "width": 130, "sum": True},
    {"name": "surplus",           "label": "M. Surchats",     "type": "amount",     "width": 130, "sum": True},
    {"name": "balance",           "label": "Reste",           "type": "amount",     "width": 130, "sum": True},
    {"name": "status",            "label": "Statut",          "type": "status",     "width": 100, "align": "center"},
]
